  ...
  render() {
    return (
      ...
      <div className='documentation-card m-5 p-4 col-8'>
        ...
        <h4>The current use of technology in the construction and trade sector is being greatly underutilised. Time is lost trying to manage or access documentation that can aid in problem diagnosis or operational optimisation. Such documentation is often necessary, but unavailable due to mistrust or inconvenience.</h4>
        <h4>Work sites generate enormous amounts of documentation, which are printed and filled out by hand, resulting in communication delays and the consumption of excessive quantities of paper. This becomes a recurring problem as records (technical drawings, permits, etc) are often destroyed or damaged and have to be re-printed and distributed, causing significant financial and environmental cost.</h4>
        <h4>Additionally, existing technologies which monitor services generally don’t relay vital information to field staff. This information is often inadequately communicated to relevant staff, with multiple channels to pass through before reaching the desired field employee which leads to delays and inefficient deployment of staff.</h4>
        <h4>Such information can be imperative to minimising the workload of repair services, which often require the use of antiquated tools and old, damaged drawings for diagnosis. These outdated practices often mean that any data collected is not fully utilised to better improve business operations.</h4>
        <br/>
        <ul>
          <h5>
